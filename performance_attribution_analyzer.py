...
class PerformanceAttributionAnalyzer:
    ...
    def _calculate_single_strategy_performance(self, strategy_name: str, trades: list[dict]) -> StrategyPerformance | None:
    ...
    def _calculate_single_factor_attribution(self, factor: PerformanceFactors, trades: list[dict]) -> FactorAttribution | None:
