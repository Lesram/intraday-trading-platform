...
from unified_risk_manager import PositionRisk, RiskLevel, get_risk_manager
...
class IntegratedRiskDashboard:
    ...
    def save_dashboard_snapshot(self, dashboard_data: RiskDashboardData, filename: str | None = None):
