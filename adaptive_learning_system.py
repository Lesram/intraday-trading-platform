...
class DriftDetector:
    ...
    def load_baseline_stats(self):
        ...
        try:
            ...
            if baseline_file.exists():
                ...
                logging.info("📊 Loaded baseline statistics")
            else:
                self.baseline_stats = {}
    ...
    def save_baseline_stats(self):
        ...
        try:
            ...
            logging.info("💾 Saved baseline statistics")
        except Exception as e:
...
def main():
    ...
    while True:
        ...
        print("\nOptions:")
        print("1. Generate performance metrics")
        print("2. Test drift detection")
        print("3. Simulate retraining decision")
        print("4. Start adaptive monitoring (demo)")
