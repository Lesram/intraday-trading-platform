...
import ComprehensiveHealthMonitor from '../components/ComprehensiveHealthMonitor';
        ...
        ws.onmessage = (event) => {
          try {
            ...
            if (data.type === 'real_time_update') {
              ...
              setPortfolioData(data.portfolio as any);
              setSystemHealth(data.health || [] as any);
              setLastUpdate(new Date().toLocaleTimeString());
            }
          } catch (err) {
    ...
    <Box sx={{ flexGrow: 1, p: 3 }}>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} lg={6}>
          <ComprehensiveHealthMonitor onHealthUpdate={(healthy) => {
